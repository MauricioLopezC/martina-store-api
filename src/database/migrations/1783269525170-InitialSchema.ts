...
export class InitialSchema1783269525170 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "attributes" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "UQ_89afb34fd1fdb2ceb1cea6c57df" UNIQUE ("name"), CONSTRAINT "PK_32216e2e61830211d3a5d7fa72c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "attribute_values" ("id" SERIAL NOT NULL, "attributeId" integer NOT NULL, "value" character varying NOT NULL, CONSTRAINT "UQ_39d8e6de4e79a6ba892428f16f9" UNIQUE ("attributeId", "value"), CONSTRAINT "PK_3babf93d1842d73e7ba849c0160" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" SERIAL NOT NULL, "parentId" integer, "name" character varying NOT NULL, "slug" character varying NOT NULL, "description" text, "active" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_420d9f679d41281f282f5bc7d09" UNIQUE ("slug"), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "product_images" ("id" SERIAL NOT NULL, "productId" integer NOT NULL, "url" character varying NOT NULL, "position" integer NOT NULL DEFAULT '0', "isCover" boolean NOT NULL DEFAULT false, "altText" character varying, CONSTRAINT "PK_1974264ea7265989af8392f63a1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."products_status_enum" AS ENUM('draft', 'published', 'archived')`,
    );
    await queryRunner.query(
      `CREATE TABLE "products" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" text, "active" boolean NOT NULL DEFAULT true, "slug" character varying NOT NULL, "brand" character varying, "status" "public"."products_status_enum" NOT NULL DEFAULT 'draft', CONSTRAINT "UQ_464f927ae360106b783ed0b4106" UNIQUE ("slug"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "carts" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_69828a178f152f157dcf2f70a89" UNIQUE ("userId"), CONSTRAINT "PK_b5f695a59f5ebb50af3c8160816" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "variant_attribute_values" ("variant_id" integer NOT NULL, "attribute_value_id" integer NOT NULL, CONSTRAINT "PK_82eb016987ab53367e1a442c9a2" PRIMARY KEY ("variant_id", "attribute_value_id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_5df07e5f75117c9eca2c2ba505" ON "variant_attribute_values" ("variant_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c714239ff4355d5e4dbfed5d19" ON "variant_attribute_values" ("attribute_value_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cart_items" ADD CONSTRAINT "FK_5a27845bc2d79be6f1fa3d2c036" FOREIGN KEY ("variantId") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" ADD CONSTRAINT "FK_5df07e5f75117c9eca2c2ba5051" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" ADD CONSTRAINT "FK_c714239ff4355d5e4dbfed5d196" FOREIGN KEY ("attribute_value_id") REFERENCES "attribute_values"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" DROP CONSTRAINT "FK_c714239ff4355d5e4dbfed5d196"`,
    );
    await queryRunner.query(
      `ALTER TABLE "variant_attribute_values" DROP CONSTRAINT "FK_5df07e5f75117c9eca2c2ba5051"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "attribute_values" DROP CONSTRAINT "FK_b8f8e1d9141248b538c9285574e"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c714239ff4355d5e4dbfed5d19"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_5df07e5f75117c9eca2c2ba505"`,
    );
